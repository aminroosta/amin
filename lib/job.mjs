...
export class EramJob {
  ...
  static register(config = {}) {
    ...
    if (!this.prototype.perform || typeof this.prototype.perform !== 'function') {
      throw new MissingPerformMethodError(config.name);
    }
 ...
 */
class MissingPerformMethodError extends Error {
  constructor(class_name) {
    super(`Class ${class_name} must define an async perform() method.`);
    this.name = 'MissingPerformMethodError';
  }
}
